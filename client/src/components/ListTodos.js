          ...
          <TableBody>
            {todos.map((todo) => (
              <TableRow key={todo.todo_id}>
                ...
                <TableCell component="th" scope="row">
                  <Button variant="contained" color="primary" onClick={handleOpen(todo.todo_id)}>
                    Open Modal
                  </Button>
                </TableCell>
                <TableCell component="th" scope="row">
                  <Button variant="contained" color="primary" onClick={() => deleteTodo(todo.todo_id)}>Delete</Button>
                </TableCell>
              </TableRow>
            ))}
            <Modal
              ...
              <div style={modalStyle} className={classes.paper}>
                <EditTodo todo={todos.filter(todo => todo.todo_id === modalState.todoId)[0]} handleClose={handleClose} />
              </div>
            </Modal>
          </TableBody>
        </Table>
